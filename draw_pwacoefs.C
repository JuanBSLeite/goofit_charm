...
TH2F *h1 = new TH2F("h1","Magnetude",100,s12_min,s12_max,100,0,160);
h1->SetTitle("Magnetude");
h1->SetMarkerStyle(3);
h1->SetMarkerColor(kBlue);
h1->GetXaxis()->SetTitle("m^{2}(#pi^{-}#pi^{+}) MeV");
h1->GetYaxis()->SetTitle("Magnetude");
...
TH2F *h2 = new TH2F("h2","Fase",100,s12_min,s12_max,100,0.5,3.5);
h2->SetTitle("Fase");
h2->SetMarkerStyle(3);
h2->SetMarkerColor(kBlue);
h2->GetXaxis()->SetTitle("m^{2}(#pi^{-}#pi^{+}) MeV");
h2->GetYaxis()->SetTitle("Fase");
